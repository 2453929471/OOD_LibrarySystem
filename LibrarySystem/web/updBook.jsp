  ...
  <div class="m-right">
    <div class="right-nav">
      <ul>
        ...
        <li>></li>
        <li><a href="#">UpdateBook</a></li>
      </ul>
    </div>
    <div class="main">
      <form action="admin/searchByIsbn" method="post">
      ...
      <form action="admin/updBook" method="post">
        ...
        Category:<s:select name="category" list="{1:'Arts & Photography','Biographies & Memoirs ','Business & Money','Calendars','Computers & Technology'}" value="#request.book.category"/><br>
