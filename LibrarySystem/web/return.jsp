...
<div id="works-section">
  <div class="container"> <!-- Container -->
    ...
    <h5><label ><strong style="color: #D2527F;">SFZ: &nbsp;&nbsp;&nbsp;</strong></label> <span style="text-transform:none;"> <input type="text" name="sfzr" value="<s:property value='#request.u.sfz'/>"/></span></h5>
