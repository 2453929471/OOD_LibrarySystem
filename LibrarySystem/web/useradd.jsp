...
<div id="works-section">
  <div class="container"> <!-- Container -->
    ...
    <form action="admin/addUser" method="post">
      <h5><label><strong style="color: #D2527F;">Username:&nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"><input type="text" name="name"/></span></h5><br>
      <h5><label><strong style="color: #D2527F;">Password:&nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"><input type="text" name="pwd"/></span></h5><br>
      <h5><label><strong style="color: #D2527F;">Phone:&nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"> <input type="text" name="phone"/></span></h5>
      <h5><label><strong style="color: #D2527F;">Email: &nbsp;&nbsp;&nbsp;</strong></label> <span style="text-transform:none;"> <input type="text" name="email" /></span></h5>
      <h5><label ><strong style="color: #D2527F;">SFZ: &nbsp;&nbsp;&nbsp;</strong></label> <span style="text-transform:none;"> <input type="text" name="sfz"/></span></h5>
      <h5><label ><strong style="color: #D2527F;">authority: &nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"> <input type="text" name="authority"/></span></h5>
