  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="admin/admin.action">BookManagement</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse -->
  </div>
...
<div id="works-section">
    <div class="container"> <!-- Container -->
        ...
        <form action="admin/crawler" method="post">
            <h5><label><strong style="color: #D2527F;">ISBN:&nbsp;&nbsp;&nbsp;</strong></label> <span style="text-transform:none;">  <input type="text" name="isbn1" value="<s:property value='#request.book.isbn'/>"/> </span></h5>
        ...
        <h5><label><strong style="color: #D2527F;">Title:&nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"> <input type="text" name="bname" value="<s:property value='#request.book.bname'/>" /></span></h5>
        <h5><label><strong style="color: #D2527F;">Author:&nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"> <input type="text" name="author" value="<s:property value='#request.book.author'/>" /></span></h5>
        <h5><label><strong style="color: #D2527F;">Publisher: &nbsp;&nbsp;&nbsp;</strong></label> <span style="text-transform:none;"> <input type="text" name="publisher" value="<s:property value='#request.book.publisher'/>" /></span></h5>
        <h5><label ><strong style="color: #D2527F;">Category: &nbsp;&nbsp;&nbsp;</strong></label> <span style="text-transform:none;"> <s:select name="category" list="#request.catList" value="#request.book.category"/></span></h5>
        <h5><label ><strong style="color: #D2527F;">Price: &nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"> <input type="text" name="price" value="<s:property value='#request.book.price'/>" /></span></h5>
