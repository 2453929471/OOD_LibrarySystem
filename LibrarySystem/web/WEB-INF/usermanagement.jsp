...
<nav id="menu" class="navbar navbar-default navbar-fixed-top" style="background-color: #000">
  <div class="container">
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="admin2.jsp">MyLibrary<strong><span class="color">.Admin</span></strong></a> </div>
...
<div id="works-section">
          <div class="container"> <!-- Container -->
              <div class="section-title text-center center">
                  <h2 style="text-transform: none;">User Management</h2>
              ...
              <form action="admin/queryUserInfo" method="get" name="form1">
                  <span style="text-transform:none;">  <input type="text" name="uid" id="uid" value="<s:property value='#request.u.uid'/>" PLACEHOLDER="UID"/> </span>
                  <button type="button" class="search" onclick="validate()"><span style="color:white">Query</span></button>
              </form>
...
<script type="text/javascript">
    function validate(){
        if(isNaN(document.getElementById("uid").value)||document.getElementById("uid").value.length>9){
