...
<div id="works-section">
    <div class="container"> <!-- Container -->
        <div class="section-title text-center center">
            <h2 style="text-transform: none;">Add Book Info. Success</h2>
            <hr style="margin:0 auto">
            <br>
        </div>
        <h5><label>Bid:&nbsp;&nbsp;&nbsp;</label><span style="text-transform:none;"> <s:property value="#request.b.bid" /></span></h5>
        <h5><label>Title:&nbsp;&nbsp;&nbsp;</label><span style="text-transform:none;"> <s:property value="#request.b.bname" /></span></h5>
        <h5><label>Author:&nbsp;&nbsp;&nbsp;</label><span style="text-transform:none;"> <s:property value="#request.b.author" /></span></h5>
        <h5><label>Publisher: &nbsp;&nbsp;&nbsp;</label><span style="text-transform:none;"> <s:property value="#request.b.publisher"/></span></h5>
        <h5><label >Category: &nbsp;&nbsp;&nbsp;</label> <span style="text-transform:none;"> <s:property value="#request.b.category"/></span></h5>
        <h5><label >Price: &nbsp;&nbsp;&nbsp;</label><span style="text-transform:none;">  <s:property value="#request.b.price"/></span></h5>
        <h5><label>ISBN:&nbsp;&nbsp;&nbsp;</label> <span style="text-transform:none;"> <s:property value="#request.b.isbn"/></span></h5>
        <h5><label >Description:</label><br></h5>
        <h5><span style="text-transform:none;"> <c:out value="${b.explanation}" escapeXml="false"></c:out></span></h5><br>
        <hr>
        <button type="button" class="search" onclick="window.location.href='admin/preadd'"><span style="color:white">Add Book</span></button>
