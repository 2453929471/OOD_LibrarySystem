...
<div id="works-section">
  <div class="container"> <!-- Container -->
    <div class="section-title text-center center">
      <h2 style="text-transform: none;">Borrow Service</h2>
      <hr style="margin:0 auto">
      <br>
    </div>
    <form action="admin/preborrow" method="get">
      <span style="text-transform:none;">  <input type="text" name="uid" value="<s:property value='#request.u.uid'/>" placeholder="UID"/> </span>&nbsp;&nbsp;<button type="submit" class="search"><span style="color:white">Query</span></button>
    </form>
    ...
    <form action="admin/borrow" method="post"><input type="hidden" name="uid" value="<s:property value='#request.u.uid'/>">
     <span style="text-transform:none;">  <input type="text" name="bid" PLACEHOLDER="BID"/> </span>
