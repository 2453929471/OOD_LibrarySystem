...
<div id="works-section">
          <div class="container"> <!-- Container -->
              ...
              <button type="button" class="search" onclick="window.location.href='useradd.jsp'"><span style="color:white">Add User</span></button>
              <form action="queryUserInfo" method="get">
              ...
              <h5><label><strong style="color: #D2527F;">Phone:&nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"> <input type="text" name="author" value="<s:property value='#request.u.phone'/>" /></span></h5>
              <h5><label><strong style="color: #D2527F;">Email: &nbsp;&nbsp;&nbsp;</strong></label> <span style="text-transform:none;"> <input type="text" name="publisher" value="<s:property value='#request.u.email'/>" /></span></h5>
              <h5><label ><strong style="color: #D2527F;">SFZ: &nbsp;&nbsp;&nbsp;</strong></label> <span style="text-transform:none;"> <input type="text" name="publisher" value="<s:property value='#request.u.sfz'/>"/></span></h5>
              <h5><label ><strong style="color: #D2527F;">authority: &nbsp;&nbsp;&nbsp;</strong></label><span style="text-transform:none;"> <s:property value='#request.u.bnum'/>|<s:property value='#request.u.authority'/></span></h5>
          ...
          <s:iterator value="#request.blist" id="book" status="L">
              <tr class="selectable">
                  ...
                  <td class="center" style="max-width: 15px;"><s:property value="#book.isbn"/></td>
